...
export default function AdminPage() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#f6f6f8] text-neutral-900">
        <div className="flex flex-col items-center gap-4">
          <div className="h-8 w-8 animate-spin rounded-full border-4 border-neutral-200 border-t-primary-500"></div>
          <div className="font-medium text-neutral-500">Carregando painel administrativo...</div>
        </div>
      </div>
    )
  }
  ...
  if (error) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-[#f6f6f8] p-4 text-neutral-900">
        <div className="w-full max-w-md rounded-[28px] border border-amber-200 bg-amber-50 p-8 text-center shadow-soft">
          ...
          <h2 className="text-2xl font-semibold text-neutral-900">Painel indisponível</h2>
          <p className="mt-2 text-neutral-600">{error}</p>
          {statusCode === 401 ? (
            <div className="mt-8 flex flex-col gap-3">
              <Link href="/login?redirect=/admin" className="inline-flex w-full items-center justify-center rounded-full bg-primary-500 px-6 py-3 text-sm font-semibold text-white transition hover:bg-primary-600">
                Entrar como admin
              </Link>
              <Link href="/" className="inline-flex w-full items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-semibold text-neutral-700 border border-neutral-200 transition hover:bg-neutral-50">
                Voltar para a loja
              </Link>
            </div>
          ) : null}
